//
//  CompeListController.swift
//  golfScore
//
//  Created by gs_fukumoto on 2017/11/09.
...
class CompeListController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        appDelegate.compeId = article["comp_id"]!!
